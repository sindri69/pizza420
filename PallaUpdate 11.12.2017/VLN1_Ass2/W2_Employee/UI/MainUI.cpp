...
void MainUI::start_MainMenu() {
    ...
    while (input != 'q') {
        ...
        cout << "6. Get the name of the employee with the highest total salary for a given year" << endl;
        cout << "7. Delete the Employees-list" << endl;
        ...
        if (input == '1') { /// Here we add new employee
            ...
            fun.find_HighestEarner_employee(myfun.getAnswer("Which year would you like to check?"));
        }
        else if (input == '7') { /// Here we remove all the lines in the file "employee.txt"
