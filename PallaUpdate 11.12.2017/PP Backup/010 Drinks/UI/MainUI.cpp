...
void MainUI::start_AdminMenu() {
    ...
    while (input != 'q') {
        ...
        cout << "4. Go to Drinks" << endl;
        cout << "5. Go to Extras" << endl;
        ...
        else if (input == '4') { /// Jump to DrinksMenu
            system("CLS");
            DrinkUI d;
            d.start_DrinksMenu();
        }
        else if (input == '5') { /// Jump to ExtrasMenu
            system("CLS");
            //ExtraUI e;
            //e.start_ExtrasMenu();
        }
        else if (input == '6') { /// Return to MainMenu
            system("CLS");
            input = 'q';
        }
        else {
...
void MainUI::start_SalesMenu() {
    ...
    while (input != 'q') {
        ...
        cout << "1. Go to Orders" << endl;
        cout << "2. Go to Payments" << endl;
        cout << "3. Go to Delivery" << endl;
        cout << "4. Return to Main" << endl;

        cin >> input;

        if (input == '1') { /// Goes to the OrderUI
            system("CLS");
            OrderUI oui;
            oui.start_OrdersMenu();
        }
        else if (input == '2') { /// Goes to the PaymentUI
            system("CLS");
            PaymentUI pui;
            pui.start_PaymentsMenu();
        }
        else if (input == '2') { /// Goes to the DeliveryUI
            cout << endl;
        }
        else if (input == '4') { /// Returns to MainMenu
            system("CLS");
            input = 'q';
        }
        else {
