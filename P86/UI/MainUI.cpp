...
void MainUI::start_AdminPizzaMenu() {
    ...
    while (input != 'q') {
        ...
        cout << "3. View all Pizzas" << endl;
        cout << "4. View the Pizza-List (raw)" << endl;
        cout << "5. Delete pizzalist" << endl;
        cout << "6. Return to Administrator" << endl;
        ...
        else if (input == '4') { /// Here we read all lines in the file
            fun.read_raw_pizza();
            cout << endl;
        }
        else if (input == '5') { /// Here we remove all the lines in the file "pizza.txt"
